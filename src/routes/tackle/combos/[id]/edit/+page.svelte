...
<div style="max-width:520px; margin:0 auto;">
	<a href="/tackle/combos/{c.id}" style="display:inline-flex; align-items:center; gap:6px; color:#3d6a84; font-size:0.8rem; text-decoration:none; margin-bottom:20px;"
	...
	<form method="POST" action="?/update" style="background:#0b1a2c; border:1px solid #172f4a; border-radius:16px; padding:24px 28px; display:flex; flex-direction:column; gap:20px;">
		<h1 style="font-family:'Carter One',sans-serif; font-size:1.4rem; color:#e0eaf8; margin:0;">{t.comboEditTitle}</h1>
		<div>
